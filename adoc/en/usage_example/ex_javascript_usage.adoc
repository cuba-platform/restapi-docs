...
To show the list of customers, the request is sent to the server <<rest_api_v2_ex_get_entities_list,to get the instances>> of the `sales_Customer` entity, passing the `oauthToken` value in the `Authorization` header.
